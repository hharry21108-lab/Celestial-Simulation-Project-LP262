...
int main() {
    ...
    b = {
        ...
        {"Earth",   5.972e24, -1.0 * AU, 0, 0, -VE, 0, 0, {50, 150, 255, 255}},
        {"Moon",    7.348e22, -1.00257 * AU, 0, 0, -VE + 1022, 0, 0, {180, 180, 180, 255}},
    ...
    // 动态添加地球的 L4 和 L5 点
    b.push_back({ "Earth_L4", 10.0, -AU * COS60, -AU * SIN60, VE * SIN60, -VE * COS60, 0, 0, {0, 255, 120, 255} });
    b.push_back({ "Earth_L5", 10.0, -AU * COS60,  AU * SIN60, -VE * SIN60, -VE * COS60, 0, 0, {255, 120, 255, 255} });
