...
const double Rm = 3.844e8;
const double vE = 29780.0;
const double vMoonRel = 1022.0;
...
int main() {
    ...
    b[0].y = 0;
    b[0].vx = 0;
    b[0].vy = -(5.972e24 / 1.989e30) * vE;  // 反向速度
    ...
    // L4 small body
	b[3].mass = 1e20;// 质量很小，不影响地月系统
    b[3].x = AU * 0.5;
    b[3].y = AU * 0.866025403784;
    b[3].vx = 0.866025403784 * vE;
    b[3].vy = 0.5 * vE;
